...
$(document).ready(function() {
	tableObj = dataTable.dataTable({
		...
		'aoColumnDefs': [
         	...
         	{ 'sClass': 'left width_percent_22', 'aTargets': [ 1 ] },
         	{ 'sClass': 'left width_percent_22', 'aTargets': [ 2 ] },
         	{ 'sClass': 'left width_percent_22', 'aTargets': [ 3 ] },
         	{ 'sClass': 'left width_percent_22', 'aTargets': [ 4 ] },
         	{ 'bSortable': false, 'aTargets': [ 0, 1, 2, 3, 4 ] }
         ],
         'bServerSide': true,
         'bProcessing': true,
         'sAjaxSource': "<%=request.getAttribute(AttributeName.BASE_URL.value()) %>" + "api/comments/get_comments",
