...
public class MenuModule {
	...
	public Map<MenuItem, List<MenuItem>> getMenuItems() {
		...
		Map<MenuItem, List<MenuItem>> menus = (Map<MenuItem, List<MenuItem>>) memcache.getValue("menus");
		
		if (menus == null) {
			menus = new LinkedHashMap<MenuItem, List<MenuItem>>();
